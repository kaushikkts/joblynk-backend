...
import {
    ...
    registerSubEmailSend, sendTradesmanAgreementToSubcontractor,
...
export default (router: express.Router) => {
    ...
    router.post('/subcontractor/documents/sendTradesmanAgreement',verifyToken, sendTradesmanAgreementToSubcontractor);
